    ...
    try {
        ...
        querySnapshot.forEach((doc) => {
            ...
            window.hiraProducts.push({ 
                ...
                image: data.image || data.imageUrl || 'https://via.placeholder.com/400x600?text=لا+توجد+صورة',
        ...
        console.log("Products successfully loaded from Firebase:", window.hiraProducts);
